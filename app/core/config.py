...
class Settings:
    ...
    refresh_jwt_audience: str = "rag-doc-refresh"
    refresh_jwt_issuer: str = "rag-doc-api"
    ...
    admin_refresh_cookie_name: str = "ragdoc_admin_refresh"
    chat_session_cookie_name: str = "ragdoc_chat_session"
    chat_refresh_cookie_name: str = "ragdoc_chat_refresh"
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        refresh_jwt_audience=os.getenv("REFRESH_JWT_AUDIENCE", "rag-doc-refresh"),
        refresh_jwt_issuer=os.getenv("REFRESH_JWT_ISSUER", "rag-doc-api"),
        ...
        admin_refresh_ttl_seconds=int(os.getenv("ADMIN_REFRESH_TTL_SECONDS", "604800")),
        admin_session_cookie_name=os.getenv("ADMIN_SESSION_COOKIE_NAME", "ragdoc_admin_session"),
        admin_refresh_cookie_name=os.getenv("ADMIN_REFRESH_COOKIE_NAME", "ragdoc_admin_refresh"),
        chat_session_cookie_name=os.getenv("CHAT_SESSION_COOKIE_NAME", "ragdoc_chat_session"),
        chat_refresh_cookie_name=os.getenv("CHAT_REFRESH_COOKIE_NAME", "ragdoc_chat_refresh"),
